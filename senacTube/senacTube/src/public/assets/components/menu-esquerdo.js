  ...
  connectedCallback() {
    this.innerHTML = `
      ...
      <ul>
        <li>
          <a href="/">
            <svg xmlns="#www.w3.org/2000/svg" fill="currentColor" height="24" viewBox="0 0 24 24" width="24"
